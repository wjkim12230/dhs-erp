  ...
  const columns = [
    ...
    { key: 'actions', label: '', width: 100, render: (_: any, r: any) => (
      <div className="flex gap-1">
        <Tooltip content="상세"><Button isIconOnly size="sm" variant="light" onPress={() => navigate(`/specifications/${r.id}/details`)}><List size={14} /></Button></Tooltip>
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold">사양관리</h1>
        <Button color="primary" startContent={<Plus size={16} />} onPress={() => navigate('/specifications/create')}>사양 등록</Button>
      </div>
